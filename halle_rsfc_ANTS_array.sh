#!/bin/bash -l 
#
#SBATCH --job-name=ANTS_halle_rsfc_8_18_18
#SBATCH --output=/home/wbreilly/halle_data_ants_crick/logs/ANTS_halle_rsfc_8_18_18.%j.%N.out
#SBATCH --error=/home/wbreilly/halle_data_ants_crick/logs/ANTS_halle_rsfc_8_18_18.%j.%N.err
#SBATCH --nodes=1
#SBATCH -c 2  # might only need 1? 
